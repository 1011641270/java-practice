...
public class MyServerHandler extends ChannelHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        MyChannelHandlerPool.channelGroup.add(ctx.channel());  //添加到通道組
        
        String str = "Server Connected : "+" "+new Date()+" "+ctx.channel().localAddress();
        ctx.writeAndFlush(str); //str会发送给客户端
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        MyChannelHandlerPool.channelGroup.remove(ctx.channel()); //移除通道組
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg)
        ...
        //群发消息
        String str = "Client Msg : "+new Date()+" "+msg+"\r\n";
        System.out.println(str);
        
        MyChannelHandlerPool.channelGroup.writeAndFlush(str); //str会发送给客户端
    }
